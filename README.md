...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/plugcli-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15596&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/plugcli-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `plugcli` can be installed with:

```
conda install plugcli
```

It is possible to list all of the versions of `plugcli` available on your platform with:
